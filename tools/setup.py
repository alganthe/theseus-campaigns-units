...
def main():
    ...
    print("""
  ######################################
  # TCU Development Environment Setup #
  ######################################

  This script will create your TCU dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your TCU project folder:
    [Arma 3 installation directory]\\{} => TCU project folder
    P:\\{}                              => TCU project folder
